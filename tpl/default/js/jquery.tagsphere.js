...
(function($){
	 ...
	 var points = [];
         ...
         $('li a', container).each(function(idx, val){
                                       ...
                                       container.append('<div id="'+ id_stub + idx +'" class="point" style="position:absolute;"><a href=' + $(this).attr('href')  + ' title=' + $(this).attr('title') + '>' + $(this).html()  + '</a></div>');
                                   });
        ...
        /* container.mousemove(function(evt){
        	 						  move_x = evt.clientX;
        	 						  max_move_x = move_x+200;
        	 						  move_y = evt.clientY;
        	 						  max_move_y = move_y + 200;
                                // moved(evt.clientX, evt.clientY);
        	 						 moved(move_x, move_y);
                             });*/
          bool_flag = false;
         /*container.mouseover(function(evt){
        	 						 $('#tags_comment').slideToggle("slow");
						      });
