...
$reply = '"'.$zengl_cms_rootdir.'comment_operate.php?action=reply&type=admin' .
		'&commentID=<?php echo $sql->row["comment_ID"]; ?>&articleID=<?php echo $sql->row["articleID"]; ?>"';
$article_a = '"'.$zengl_cms_rootdir.'comment_operate.php?action=admin_comment_list' .
		'&articleID=<?php echo $sql->row["articleID"]; ?>&sec_page=1"';
$username_a = '"'.$zengl_cms_rootdir.'comment_operate.php?action=admin_comment_list' .
		'&username=<?php
		...
		?>&sec_page=1"';
$nickname_a = '"'.$zengl_cms_rootdir.'comment_operate.php?action=admin_comment_list' .
...
$title = '评论管理';
$filetpl = $zengl_cms_tpl_dir . $zengl_theme . '/admin_list_comments.tpl';
$filecache = $zengl_cms_tpl_dir . 'cache/admin_list_comments_cache.php';
